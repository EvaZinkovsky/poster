...
![](resources/img/regex.jpg){width=100px style="float: left; margin-right: 2%"} 
allows you to pull out the exact subset of data that you need.

![](resources/img/matplotlib.png){width=200px style="float: left; margin-right: 2%"}
The second is matplotlib which allows you to make lovely visualisations from your data. 
...
knitr::kable(head(py$fcast_vs_obs), table.attr = "style='width:20%;'", row.names = F) %>% 
  kable_styling( 
